...
## Change in biovariable as well as different algorithms also have to be repeated to achieve better model. Here the accuracy of the model is limited with the algorithm used. Maxtend and other methods also should be tested for the performance which can be done with the same code.
